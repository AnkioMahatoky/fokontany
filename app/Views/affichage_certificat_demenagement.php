...
<body>
    <div >
        ...
        <div class ="d-flex justify-content-center align-items-center text-center">
            ...
            <div>
                <div class="card text-center">
                    <h6>FANAMARINAM-PIFINDRA-MONINA</h6>
                    <h6><i>ATTESTATION DE DEMENAGEMENT</i></h6>
                </div>
        ...
        <div class="text-center">
            <p>Ny voatonona etsy ambony dia nampahafantatra ity Fokontany ity fa hifindra monina raikitra ho any amin’ny :<br>
            <strong>Adiresy vaovao:</strong> <?= $adiresy ?></p><br>
            
            <!-- <p><i>EST BIEN ET S'EST PRESENTE(E) DEVANT NOUS AUJOURD'HUI MËME</i></p> -->
        </div>
        <p class = "mx-5">Noho izany dia omena azy ity fanamarinana ity noho ny fangatahana izay nataony,
             mba hananany lanja ara-dalàna amin’izay rehetra ilàna azy, indrindra indrindra amin’ny raharaha 
             ara-panjakana mifandraika amin'izany.<br>
        </p>
