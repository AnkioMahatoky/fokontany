    ...
    <style>
        *{
        ...
        .tongasoa{
            height: 100vh;
            width: 30vw;
            background-image: url("../../dist/img/demenage.jpeg");
...
<body>
    <div class="container">
        ...
        <div class="form">
          <h2 class="text-center">Taratasy fenoina hakàna <span>Fifindra-monina</span></h2>
          <?php if (session()->getFlashdata('error')): ?>
            <div class="alert">
                <?= session()->getFlashdata('error') ?>
            </div>
            <?php endif; ?>
          <form method="post" action="formulaire_demenagement?>">
  ...
  oninput="this.setCustomValidity('')"><br>
              ...
              <label for="numeroCopie">Adiresy vaovao</label><br>
              <input type="text" class="form-control" name="nouvAdresse" value="<?= old('nouAdresse') ?>"><br>
